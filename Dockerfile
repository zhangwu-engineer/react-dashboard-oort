...
ARG REACT_APP_CTRL_API_URL
ARG REACT_APP_OORT_TOKEN_DOMAIN
RUN env REACT_APP_OKTA_ISSUER=$REACT_APP_OKTA_ISSUER\
        ...
        REACT_APP_CTRL_API_URL=$REACT_APP_CTRL_API_URL\
        REACT_APP_OORT_TOKEN_DOMAIN=$REACT_APP_OORT_TOKEN_DOMAIN\
        npm run build-all
